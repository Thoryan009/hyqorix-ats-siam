<template>
  <div :class="embedded ? '' : 'rounded-lg bg-white shadow-sm'">
    ...
    >
      <div>
        <h3 class="text-base font-semibold text-gray-900">Income Category Management</h3>
        <p class="mt-1 text-sm text-gray-500">
          Manage income categories from the server
        </p>
      </div>
    </div>
    ...
    <IncomeCategoryEditModal v-can="'account_setup.edit'" />
  </div>
</template>
...
const IncomeCategoryEditModal = defineAsyncComponent(
  () => import('./IncomeCategoryEditModal.vue')
)
