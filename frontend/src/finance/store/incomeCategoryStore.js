...
import { fetchAll, updateData } from '../services/incomeCategoryService'
import { findCategoryByCode as findCategoryByCodeUtil } from '../data/incomeCategoryCodes'
...
export const useIncomeCategoryStore = defineStore('incomeCategory', () => {
  ...
  const moduleName = 'Income Category'
  ...
  async function updateCategory(payload) {
    try {
      ...
      return { ok: false, message: getApiErrorMessage(error, 'Failed to update income category.') }
    }
  }
