export default {
 setting: {
  ...
  backup: {
    ...
    download_database_backup_description: "Download a complete backup of your database (.sql file) directly to your computer.",
    preparing_download: "Preparing Download...",
    download_backup: "Download Backup",

    schedule_automatic_backup: "Schedule Automatic Backup",
    schedule_automatic_backup_description: "Save an email address to receive scheduled database backups (.sql file) automatically.",
