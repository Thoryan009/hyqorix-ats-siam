export default {
  ...
  backup: {
    ...
    download_database_backup_description: "আপনার ডাটাবেজের সম্পূর্ণ ব্যাকআপ (.sql ফাইল) সরাসরি আপনার কম্পিউটারে ডাউনলোড করুন।",
    ...
    schedule_automatic_backup_description: "নির্ধারিত সময়ে স্বয়ংক্রিয়ভাবে ডাটাবেজ ব্যাকআপ (.sql ফাইল) পাওয়ার জন্য একটি ইমেইল ঠিকানা সংরক্ষণ করুন।",
