<template>
  <div>
    <!-- page - 1 -->
    <div class="max-w-200 mx-auto bg-white text-black p-1 text-[10px] merriweather">
      <!-- Top label part -->
      <div class="grid grid-cols-3 mt-3 gap-1 mb-2">
        ...
        <div class="flex-1 text-center mt-3">
          <div class="flex justify-center">
            <img src="/barcode-2.png" alt="Barcode" class="w-36 h-8 object-contain" />
          </div>
          <div class="font-bold text-[14px]">130496049467</div>
          <div class="text-[15px] font-bold mt-5">New Application</div>
        </div>
        <!-- Form Number -->
        <div class="text-right mt-3">
          <div class="text-3xl font-bold mb-2.5">E816528085</div>
      ...
      <table class="w-full border-collapse border border-black text-black">
        <tbody>
          ...
          <!-- Row 2: Mother's Name -->
          <tr>
            <td class="border font-semibold border-black px-2 py-[0.2px] text-[12px]" colspan="3">
              Mother's Name:
            </td>
            <td
              class="border text-[13px] border-black px-1 py-[0.2px] text-center font-bold"
          ...
          <tr>
            ...
            <td class="border font-semibold border-black px-2 py-[0.2px] text-[12px]" colspan="2">
              Place of Birth:
            </td>
            <td
          ...
          <tr>
            ...
            <td class="border font-semibold border-black px-2 py-[0.1px] text-[11.6px]" colspan="2">
              Present Nationality:
            </td>
            <td
              class="border border-black px-1 py-[0.1px] text-center font-bold text-[13px]"
          ...
          <tr>
            <td class="border font-semibold border-black px-2 py-[0.1px] text-[12px]" colspan="3">
              Sex:
            </td>
            <td
              class="border border-black px-1 py-[0.1px] text-center font-bold text-[13px]"
            ...
            <td class="border font-semibold border-black px-2 py-[0.1px] text-[12px]" colspan="2">
              Marital Status:
            </td>
            <td
              class="border border-black px-1 py-[0.1px] text-center font-bold text-[13px]"
          ...
          <tr>
            ...
            >
              <div class="grid grid-cols-6 justify-between">
                ...
                <p class="font-bold col-span-2 text-end text-[13px]">عامل تنظيف مكاتب ومنشآت</p>
          ...
          <tr>
            <td class="border border-black px-1 py-[0.1px] text-right text-[12px]" colspan="12">
              <div class="flex font-semibold justify-between">
                ...
                <p>Qualification:</p>
                <p>Profession:</p>
                <p class="font-bold text-[13px] mr-8">Offices and facilities Cleaning worker</p>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td
              ...
              colspan="12"
            >
              PLOT NO-23,ROAD NO-11,BLOCK-F,A-10,BIR UTTAM KHADEMUL BASHAR SARAWAK,BANANI,DHAKA.
            </td>
          </tr>
          ...
          <tr rowspan="2">
            ...
            <td class="border border-black px-1 py-1 text-[11px]" colspan="6">
              <div class="flex font-medium justify-center gap-2">
                <div class="border bg-gray-700 px-3 py-[0.1px]">
                  <p class="text-white arabic-text">
                    الشغل
                    <br />
                    <span class="merriweather font-semibold">Work</span>
                  </p>
                </div>
                <div class="border px-3 py-[0.1px]">
                  <p class="text-black arabic-text">
                    عبور
                    <br />
          ...
          <tr>
            ...
            <td
              ...
              colspan="3"
            >
              <p class="text-[13px]">13-01-2025</p>
            </td>
            <td
              class="text-center border text-[13px] border-black px-1 py-[0.3px] font-bold"
              colspan="3"
            >
              <p class="text-[13px]">12-01-2035</p>
            </td>
            <td
              class="text-center border text-[13px] border-black px-1 py-[0.3px] font-bold"
              colspan="3"
            >
              <p class="text-[13px]">A17516124</p>
            </td>
          </tr>
            ...
            <td class="border border-black px-1 py-[0.2px] text-center text-[12px]" colspan="12">
              <div class="flex justify-between">
                <p class="px-2">
                  ...
                  <br />
                  <span class="text-black font-semibold merriweather"
                ...
                <p>
                  <span class="text-black arabic-text">: تاريخ المغادرة </span>
                  <br />
                  <span class="text-black font-semibold merriweather">Date of departure:</span>
                </p>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td class="border border-black px-1 py-[0.2px] text-[12px] text-center" colspan="12">
              ...
              <span class="text-black arabic-text"
            ...
            <td class="border border-black px-1 py-[0.2px] text-[12px]" colspan="12">
              <p class="ml-12">
                <span class="font-semibold"
                  >Name and address of company or individual in the kingdom</span
                >
                <span class="ml-10 mr-2">:</span>
                <span class="text-black mr-1 arabic-text"
      ...
      >
        ...
        <div class="col-span-5">
          <p>
            ...
            <span class="ml-5 text-[13px] font-bold">MUJAMMEL MIA</span>
          </p>
        </div>
        <div class="col-span-2">
      ...
      <div class="grid grid-cols-12 border-b border-black pb-0.5 px-1 pl-3">
        <div class="text-[12px] col-span-3">
          <p>
            ...
            <span class="ml-8 font-bold text-[14px]">1446/08/28</span>
          </p>
        </div>
        ...
        <div class="text-[12px] col-span-2">
          <p class="font-bold text-[14px]">1304964944</p>
        </div>
      ...
      <div class="grid grid-cols-3 border-b border-black pb-0.1 pt-[0.2px] text-[12px] px-1 pl-3">
        ...
        <div>
          <p class="text-black text-center font-semibold arabic-text">مجموعة اليحيى للمقاوالت</p>
        </div>
        <div>
      ...
      <div class="grid grid-cols-12 border-b border-black pb-0.1 mt-0 text-[12px] px-1 pl-3">
        ...
        <div class="col-span-7 grid grid-cols-3">
          ...
          <div>
            <p class="font-bold text-end text-[14px]">7009460838</p>
          </div>
          <div>
      ...
      <div class="flex justify-between mt-1 text-[12px] px-1 pl-3">
        ...
        <div class="mt-1">
          <img src="/barcode-3.png" alt="Barcode" class="w-30 h-7 mx-auto" />
          <p class="text-center font-bold text-[14px]">A17516124</p>
        </div>
    ...
    <div class="max-w-200 mx-auto flex justify-center items-start text-black merriweather">
      <div class="w-full p-10 leading-relaxed mt-44">
        ...
        <div class="mb-8">
          ...
          <p class="m-0 my-1 text-sm font-medium">The Royal Embassy Kingdom Of Saudi Arabia,</p>
          <p class="m-0 my-1 text-sm font-medium">Gulshan, Dhaka, Bangladesh.</p>
        </div>
        ...
        <div class="my-10 py-5">
          <div class="flex mb-4 text-xs border-b border-gray-300 pb-2">
            ...
            <div class="font-bold flex-1 pl-25 text-left arabic-text">مجموعة اليحيى للمقاوالت</div>
          </div>
          <div class="flex mb-4 text-xs border-b border-gray-300 pb-2">
            <div class="min-w-56 font-semibold shrink-0">VISA NUMBER & DATE :</div>
            <div class="font-bold flex-1 pl-25 text-left">1304964944 Date: 1446/08/28</div>
          </div>
          <div class="flex mb-4 text-xs border-b border-gray-300 pb-2">
            <div class="min-w-56 font-semibold shrink-0">FULL NAME OF THE EMPLOYEE :</div>
            <div class="font-bold flex-1 pl-25 text-left">MUJAMMEL MIA</div>
          </div>
          <div class="flex mb-4 text-xs border-b border-gray-300 pb-2">
            <div class="min-w-56 font-semibold shrink-0">PASSPORT NO. WITH ISSUE DATE :</div>
            <div class="font-bold flex-1 pl-25 text-left">A17516124 Date: 13-01-2025</div>
          </div>
          <div class="flex mb-4 text-xs border-b border-gray-300 pb-2">
            <div class="min-w-56 font-semibold shrink-0">PROFESSION :</div>
            <div class="font-bold flex-1 pl-25 text-left">
              Offices and facilities Cleaning worker
            </div>
          </div>
          <div class="flex mb-4 text-xs border-b border-gray-300 pb-2">
            <div class="min-w-56 font-semibold shrink-0">RELIGION :</div>
            <div class="font-bold flex-1 pl-25 text-left">Muslim</div>
          </div>
        </div>
        ...
        <!-- Signature Section -->
        <div class="mt-16">
          <p class="m-0 text-sm font-medium border-t border-black w-3/12 text-center leading-4">
            Your Faithfully
          </p>
          <div class="h-10"></div>
        </div>
    ...
    <div class="max-w-200 mx-auto flex justify-center m items-start text-black merriweather">
      <div class="w-full p-10 leading-relaxed">
        ...
        <div class="text-center mb-12">
          <h1 class="m-0 text-lg font-bold border-b border-gray-400 inline-block px-4">
        ...
        <div class="my-8">
          <div class="flex mb-3 text-xs border-b border-gray-300 pb-2">
            ...
            <div class="flex-1 font-bold pl-5 text-left arabic-text">مجموعة اليحيى للمقاوالت</div>
          </div>
          <div class="flex mb-3 text-xs border-b border-gray-300 pb-2">
            <div class="font-semibold min-w-56 shrink-0">HEREBY APPOINTED:</div>
            <div class="flex-1 pl-5 font-bold text-left">MUJAMMEL MIA</div>
          </div>
          <div class="flex mb-3 text-xs border-b border-gray-300 pb-2">
            <div class="font-semibold min-w-56 shrink-0">PASSPORT NO WITH ISSUE DATE</div>
            <div class="flex-1 pl-5 font-bold text-left">A17516124 Date: 13-01-2025</div>
          </div>
          <div class="flex mb-3 text-xs border-b border-gray-300 pb-2">
          ...
          <div class="flex mb-3 text-xs border-b border-gray-300 pb-2">
            ...
            <div class="flex-1 pl-5 font-bold text-left">
              Offices and facilities Cleaning worker
            </div>
          </div>
        </div>
        ...
        <div class="text-center my-8">
          <h2 class="m-0 text-lg font-bold px-3 border-b border-gray-400 inline-block">
        ...
        <!-- Signature Section -->
        <div class="mt-64 flex justify-between">
          <div class="text-center">
            <p class="text-xs font-bold border-t border-black inline-block px-5 pt-1">
      ...
      <div class="w-full p-10 leading-relaxed">
          ...
          <table class="w-full border border-black">
            ...
            <tbody>
              <tr>
                ...
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs">E816528085</td>
              ...
              <tr>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs">1304964944</td>
                <td class="border border-black p-2 text-right text-xs arabic-text">
              ...
              <tr>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs">MUJAMMEL MIA</td>
                <td class="border border-black p-2 text-right text-xs arabic-text">
              ...
              <tr>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs">A17516124</td>
                <td class="border border-black p-2 text-right text-xs arabic-text">
              ...
              <tr>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs">12-Jan-2035</td>
                <td class="border border-black p-2 text-right text-xs arabic-text">
              ...
              <tr>
                ...
                <td class="border border-black p-2 text-center text-xs">
                  01-08-2003<br />22 years 9 months 5 days
                </td>
                <td class="border border-black p-2 text-right text-xs arabic-text">
              ...
              <tr>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs">Male</td>
                <td class="border border-black p-2 text-right text-xs arabic-text">
              ...
              <tr>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs">24597823</td>
                <td class="border border-black p-2 text-right text-xs arabic-text">
              ...
              <tr>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs">FIT</td>
                <td class="border border-black p-2 text-right text-xs arabic-text">
              ...
              <tr>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs">1BEJW9K</td>
                <td class="border border-black p-2 text-right text-xs arabic-text">
              ...
              <tr>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs"></td>
                <td class="border border-black p-2 text-center text-xs arabic-text">
        ...
        <div class="text-right mb-12">
          <p class="m-0 text-base font-semibold arabic-text">
            <span class="merriweather">MERCHANT OVERSEAS</span> - أسم المكتب
          </p>
          <p class="m-0 text-base font-semibold arabic-text">
            <span class="merriweather">1160</span> - رقم الرخصة
          </p>
        </div>
...
// Set applicant photo URL here, or leave empty to show "Photo" placeholder
const applicantPhoto = ref('')
// Example: const applicantPhoto = ref('/path/to/photo.jpg');
</script>
...
.arabic-text {
  font-family: 'OPTITimes-Roman', serif;
}
