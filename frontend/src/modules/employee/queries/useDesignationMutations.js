...
import { submitData, updateData, deleteItem, bulkDelete } from '../services/designationService'
import { toast } from '@/shared/config/toastConfig'

export function useDesignationMutations(moduleName, options = {}) {
  ...
  const removeItems = useMutation({ mutationFn: bulkDelete, onSuccess: handleSuccess, onError: handleError })
