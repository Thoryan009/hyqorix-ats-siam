<template>
  <SectionHeader>
    ...
    <PageHeader>
      <div>
        <!-- Responsive Heading -->
        <PageTitle>{{t('application.waiting_list')}}</PageTitle>
      </div>
    </PageHeader>
...
import { useWaitingListDataQuery, useApplicationsQuery } from '../queries/useApplicationsQuery'
...
const { data: applicationData } = useWaitingListDataQuery()
