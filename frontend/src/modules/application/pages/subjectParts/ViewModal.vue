<template>
  <BaseModal
    ...
    :title="t('shared.actions.view') + ' ' + t('application.subject') + ' ' + t('shared.titles.details')"
    ...
    <ViewModalLayout>
      ...
      >
        ...
        <div class="flex items-center gap-3 mb-6">
          ...
          <h3 class="text-2xl font-bold text-indigo-800">{{ t('application.subject') + ' ' + t('shared.titles.information') }}</h3>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div class="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
            <div class="flex items-center gap-2 text-gray-600 mb-1">
              ...
              <span class="text-sm font-medium">{{ t('application.subject') }} {{ t('shared.labels.name') }}</span>
            </div>
