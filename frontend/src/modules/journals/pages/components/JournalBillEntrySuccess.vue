<template>
  <div class="bill-entry-success relative mx-auto w-full max-w-2xl overflow-hidden py-6 sm:py-10">
    ...
    >
      ...
      <dl class="success-summary mx-auto mt-8 grid max-w-lg grid-cols-2 gap-3 text-left sm:grid-cols-4">
        <div
      ...
      <div class="success-actions mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-center">
        ...
        >
          {{ t('journals.success_create_new') }}
        </BaseButton>
        <BaseButton
          v-if="showApprovalAction"
          className="bg-primary text-white hover:bg-primary-hover"
          @click="emit('go-to-approval')"
        >
...
const emit = defineEmits(['go-to-approval', 'view-journals', 'create-new'])
