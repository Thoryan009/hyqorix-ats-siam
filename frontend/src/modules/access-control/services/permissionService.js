...
const BASE_URL = '/access-control/permissions'
...
// ✅ Quickly generate create/edit/view/delete for a module
export async function generateModulePermissions(payload) {
  const api = useApi()
  await api.sendRequest(`${BASE_URL}/generate-module`, 'POST', payload)
  if (api.error.value) throw api.error.value
  return api.data.value
}
