<template>
  <section id="contact" class="bg-white px-4 py-20 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-7xl">
      <div class="grid gap-12 lg:grid-cols-2 items-start">
        <!-- Left Content -->
        <div>
          <h2 class="text-3xl font-bold text-gray-900 sm:text-4xl mb-6">Get in Touch</h2>
          <p class="text-lg text-gray-600 mb-8">
            Have questions about MERCHANT OVERSEAS ATS? Our expert team is ready to help you transform
            your recruitment operations. We guarantee a response within 24 hours.
          </p>
          ...
          <div class="space-y-6">
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <p class="text-gray-600">info@norqel.com</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <p class="text-gray-600">+880 1300-643579</p>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <p class="text-gray-600">
                  House-11, Road-2, M.M Complex (Level-5),<br />
