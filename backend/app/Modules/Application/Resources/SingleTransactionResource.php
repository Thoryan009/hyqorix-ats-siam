...
class SingleTransactionResource extends JsonResource
{
    public function toArray($request): array
    {
        ...
        $feeCategories = $job?->jobListDetails?->groupBy(fn($detail) => $detail->jobListDetailsHead?->jobListDetailsCategory?->name);
        ...
        return [
            ...
            'due_amount' => $this->total_amount - $totalPaid - $discount,
            ...
            'application_unique_id' => $application?->application_id,
            ...
            // Bill Transactions
            'bill_transactions' => $this->invoiceBillTransactions->map(function ($transaction) {
                ...
                return [
                    ...
                    'due_amount' => $transaction->total_amount - $transaction->paid_amount - $discount,
